...
export const MobileNav = ({
  ...
  <motion.div
    ...
    transition={{ type: "spring", stiffness: 200, damping: 50 }}
    style={{ width: "100%" }}       // ← ALWAYS FULL-WIDTH ON MOBILE TOO
    className={cn(
  ...
  <AnimatePresence>
    {isOpen && (
      <motion.div
        ...
        exit={{ opacity: 0 }}
        className={cn(
          "absolute inset-x-0 top-16 z-50 flex w-full flex-col items-start gap-4 rounded-lg bg-gradient-to-tl from-gray-700 to-black px-4 py-8 shadow-[0_0_24px_rgba(34,42,53,.06),_0_1px_1px_rgba(0,0,0,.05),_0_0_0_1px_rgba(34,42,53,.04),_0_0_4px_rgba(34,42,53,.08),_0_16px_68px_rgba(47,48,55,.05),_0_1px_0_rgba(255,255,255,.1)_inset] dark:bg-neutral-950",
          className
        )}
      >
        {children}
